...
const ADDONS = [
    ...
    },
    {
        ...
        description: "We design & print high-conversion QR cards to put inside your delivery bags. Convert Delivery Apps users to Direct Orders. Includes 500 Premium Cards + Custom Branded Tapes.",
        setupFee: 5000,
        monthlyFee: 0,
        results: "Steal your customers from Delivery Apps"
    },
    {
        id: "addon-5",
