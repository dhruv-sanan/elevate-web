        ...
        <section className="w-full py-24 px-6 bg-gradient-to-b from-transparent to-black/5 dark:to-white/5">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-8 font-inter text-lg md:text-xl leading-relaxed text-muted-foreground">
                    ...
                    >
                        We've watched too many incredible Amritsar restaurants struggle. Places serving authentic Punjabi food, making customers happy—but <strong className="text-foreground">losing 40% of every order to Zomato and Swiggy.</strong>
                    </motion.p>
